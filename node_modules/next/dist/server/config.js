...
function assignDefaults(userConfig) {
    ...
    if (typeof ((ref8 = userConfig.experimental) === null || ref8 === void 0 ? void 0 : ref8.reactMode) !== 'undefined') {
        var ref5;
    ...
    if (result === null || result === void 0 ? void 0 : result.images) {
        ...
        if (images.domains) {
            ...
            // this resource
            if ((ref7 = config.assetPrefix) === null || ref7 === void 0 ? void 0 : ref7.startsWith('http')) {
