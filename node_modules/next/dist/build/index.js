        ...
        const buildResult = await nextBuildSpan.traceAsyncFn(async ()=>{
            ...
            if (!ignoreTypeScriptErrors) {
                ...
                telemetry.record((0, _events).eventTypeCheckCompleted({
                    ...
                    inputFilesCount: (ref1 = verifyResult.result) === null || ref1 === void 0 ? void 0 : ref1.inputFilesCount,
                    totalFilesCount: (ref2 = verifyResult.result) === null || ref2 === void 0 ? void 0 : ref2.totalFilesCount,
                    incremental: (ref3 = verifyResult.result) === null || ref3 === void 0 ? void 0 : ref3.incremental
                }));
            }
            ...
            const hasPages404 = (ref6 = mappedPages['/404']) === null || ref6 === void 0 ? void 0 : ref6.startsWith(_constants.PAGES_DIR_ALIAS);
            ...
            const { customAppGetInitialProps , namedExports , isNextImageImported: isNextImageImported1 , hasSsrAmpPages: hasSsrAmpPages1 , hasNonStaticErrorPage ,  } = await staticCheckSpan.traceAsyncFn(async ()=>{
                ...
                const errorPageStaticResult = nonStaticErrorPageSpan.traceAsyncFn(async ()=>{
                    var ref, ref7;
                    return hasCustomErrorPage && staticWorkers.isPageStatic('/_error', distDir, isLikeServerless, configFileName, runtimeEnvConfig, config.httpAgentOptions, (ref = config.i18n) === null || ref === void 0 ? void 0 : ref.locales, (ref7 = config.i18n) === null || ref7 === void 0 ? void 0 : ref7.defaultLocale);
                });
                        ...
                        pageRuntime !== 'edge') {
                            try {
                                ...
                                let workerResult = await isPageStaticSpan.traceAsyncFn(()=>{
                                    var ref, ref8;
                                    return staticWorkers.isPageStatic(page, distDir, isLikeServerless, configFileName, runtimeEnvConfig, config.httpAgentOptions, (ref = config.i18n) === null || ref === void 0 ? void 0 : ref.locales, (ref8 = config.i18n) === null || ref8 === void 0 ? void 0 : ref8.defaultLocale, isPageStaticSpan.id);
                                });
            ...
            telemetry.record((0, _events).eventBuildOptimize(pagePaths, {
                ...
                hasReportWebVitals: (ref4 = namedExports === null || namedExports === void 0 ? void 0 : namedExports.includes('reportWebVitals')) !== null && ref4 !== void 0 ? ref4 : false,
            ...
            if (ssgPages.size > 0) {
                ...
                await generateClientSsgManifest(prerenderManifest, {
                    distDir,
                    buildId,
                    locales: ((ref5 = config.i18n) === null || ref5 === void 0 ? void 0 : ref5.locales) || []
                });
            } else {
                const prerenderManifest = {
                    version: 3,
